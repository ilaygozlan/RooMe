...
const allApartments: Apartment[] = [
  {
    ...
    Images: ["https://picsum.photos/800/400?random=1","https://picsum.photos/800/400?random=2","https://picsum.photos/800/400?random=31","https://picsum.photos/800/400?random=32"],
    ApartmentType: 1,
    Location: "{\"address\": \"Dizengoff 100, Tel Aviv\", \"latitude\": 32.086, \"longitude\": 34.774}",
    Price: 5200,
    Description: "Modern apartment in the city center, fully furnished with balcony and elevator.",
    AmountOfRooms: 3, AllowPet: true, AllowSmoking: false, ParkingSpace: 1,
    EntryDate: "2025-11-15T00:00:00", ExitDate: null,
    Rental_ContractLength: 12, Rental_ExtensionPossible: true,
    Shared_NumberOfRoommates: 2,
    Roommates: "Name:Noa|Gender:Female|Job:Designer|BirthDate:1998-09-01|Image:https://i.pravatar.cc/100?img=45||Name:Omer|Gender:Male|Job:Engineer|BirthDate:1997-05-10|Image:https://i.pravatar.cc/100?img=32",
    Sublet_CanCancelWithoutPenalty: false, Sublet_IsWholeProperty: false,
    LabelsJson: '[{"value":"balcony"},{"value":"fridge"},{"value":"air conditioner"},{"value":"elevator"}]',
    NumOfLikes: 5, IsLikedByUser: false,
  },
  {
    ApartmentID: 102,
    Creator_ID: 2,
    ...
    Images: ["https://picsum.photos/800/400?random=3","https://picsum.photos/800/400?random=4"],
    ApartmentType: 0,
    Location: "{\"address\": \"Ben Gurion Blvd 15, Herzlya\", \"latitude\": 32.165, \"longitude\": 34.840}",
    Price: 7500,
    Description: "Spacious 4-room apartment near the beach, with private parking and garden.",
    AmountOfRooms: 4, AllowPet: false, AllowSmoking: true, ParkingSpace: 2,
    EntryDate: "2025-12-01T00:00:00", ExitDate: null,
    Rental_ContractLength: 24, Rental_ExtensionPossible: false,
    Shared_NumberOfRoommates: null, Roommates: "",
    Sublet_CanCancelWithoutPenalty: false, Sublet_IsWholeProperty: false,
    LabelsJson: '[{"value":"garden"},{"value":"parking"},{"value":"oven"},{"value":"dishwasher"}]',
    NumOfLikes: 12, IsLikedByUser: true,
  },
  {
    ApartmentID: 103,
    Creator_ID: 3,
    ...
    Images: ["https://picsum.photos/800/400?random=5","https://picsum.photos/800/400?random=6"],
    ApartmentType: 2,
    Location: "{\"address\": \"HaNeviim 22, Jerusalem\", \"latitude\": 31.783, \"longitude\": 35.221}",
    Price: 4200,
    Description: "Short-term sublet for 3 months in a cozy 2-room apartment near city center.",
    AmountOfRooms: 2, AllowPet: false, AllowSmoking: false, ParkingSpace: 0,
    EntryDate: "2025-11-10T00:00:00", ExitDate: "2026-02-10T00:00:00",
    Rental_ContractLength: null, Rental_ExtensionPossible: false,
    Shared_NumberOfRoommates: null, Roommates: "",
    Sublet_CanCancelWithoutPenalty: true, Sublet_IsWholeProperty: true,
    LabelsJson: '[{"value":"fridge"},{"value":"microwave"},{"value":"oven"},{"value":"tv"}]',
    NumOfLikes: 3, IsLikedByUser: false,
  },
  {
    ApartmentID: 104,
    Creator_ID: 4,
    ...
    Images: ["https://picsum.photos/800/400?random=7","https://picsum.photos/800/400?random=8"],
    ApartmentType: 1,
    Location: "{\"address\": \"Hertzl 12, Ramat Gan\", \"latitude\": 32.069, \"longitude\": 34.825}",
    Price: 4800,
    Description: "Shared apartment close to university, suitable for students. Includes WiFi and AC.",
    AmountOfRooms: 3, AllowPet: true, AllowSmoking: true, ParkingSpace: 0,
    EntryDate: "2025-11-20T00:00:00", ExitDate: null,
    Rental_ContractLength: 12, Rental_ExtensionPossible: true,
    Shared_NumberOfRoommates: 1,
    Roommates: "Name:Eden|Gender:Female|Job:Student|BirthDate:2000-03-15|Image:https://i.pravatar.cc/100?img=47",
    Sublet_CanCancelWithoutPenalty: false, Sublet_IsWholeProperty: false,
    LabelsJson: '[{"value":"balcony"},{"value":"air conditioner"},{"value":"washing machine"},{"value":"lamp"}]',
    NumOfLikes: 8, IsLikedByUser: false,
  },
...

  {
    ...
    Images: ["https://picsum.photos/800/400?random=9","https://picsum.photos/800/400?random=10"],
    ApartmentType: 0,
    Location: "{\"address\": \"Allenby 50, Tel Aviv\", \"latitude\": 32.068, \"longitude\": 34.771}",
    Price: 6900,
    Description: "Renovated 3-room rental near Rothschild, bright and quiet.",
    AmountOfRooms: 3, AllowPet: false, AllowSmoking: false, ParkingSpace: 0,
    EntryDate: "2025-11-25T00:00:00", ExitDate: null,
    Rental_ContractLength: 18, Rental_ExtensionPossible: true,
    Shared_NumberOfRoommates: null, Roommates: "",
    Sublet_CanCancelWithoutPenalty: false, Sublet_IsWholeProperty: false,
    LabelsJson: '[{"value":"elevator"},{"value":"ac"},{"value":"balcony"}]',
    NumOfLikes: 6, IsLikedByUser: false,
  },
  {
    ApartmentID: 106,
    Creator_ID: 6,
    ...
    Images: ["https://picsum.photos/800/400?random=11","https://picsum.photos/800/400?random=12"],
    ApartmentType: 1,
    Location: "{\"address\": \"Weizmann 7, Ra'anana\", \"latitude\": 32.184, \"longitude\": 34.873}",
    Price: 3800,
    Description: "Shared 4-room flat, large living room, friendly roommates.",
    AmountOfRooms: 4, AllowPet: true, AllowSmoking: false, ParkingSpace: 1,
    EntryDate: "2025-11-18T00:00:00", ExitDate: null,
    Rental_ContractLength: 12, Rental_ExtensionPossible: true,
    Shared_NumberOfRoommates: 3,
    Roommates: "Name:Gal|Gender:Male|Job:QA|BirthDate:1996-11-10|Image:https://i.pravatar.cc/100?img=15||Name:Lihi|Gender:Female|Job:Teacher|BirthDate:1995-04-22|Image:https://i.pravatar.cc/100?img=25||Name:Ron|Gender:Male|Job:Student|BirthDate:2002-08-01|Image:https://i.pravatar.cc/100?img=35",
    Sublet_CanCancelWithoutPenalty: false, Sublet_IsWholeProperty: false,
    LabelsJson: '[{"value":"parking"},{"value":"balcony"},{"value":"wifi"},{"value":"tv"}]',
    NumOfLikes: 10, IsLikedByUser: false,
  },
  {
    ApartmentID: 107,
    Creator_ID: 7,
    ...
    Images: ["https://picsum.photos/800/400?random=13","https://picsum.photos/800/400?random=14"],
    ApartmentType: 2,
    Location: "{\"address\": \"Jaffa 20, Haifa\", \"latitude\": 32.817, \"longitude\": 34.991}",
    Price: 3500,
    Description: "Sublet in the German Colony, sea breeze, great for remote workers.",
    AmountOfRooms: 2, AllowPet: true, AllowSmoking: false, ParkingSpace: 0,
    EntryDate: "2025-11-12T00:00:00", ExitDate: "2026-01-12T00:00:00",
    Rental_ContractLength: null, Rental_ExtensionPossible: false,
    Shared_NumberOfRoommates: null, Roommates: "",
    Sublet_CanCancelWithoutPenalty: true, Sublet_IsWholeProperty: true,
    LabelsJson: '[{"value":"fridge"},{"value":"oven"},{"value":"wifi"}]',
    NumOfLikes: 7, IsLikedByUser: false,
  },
  {
    ApartmentID: 108,
    Creator_ID: 8,
    ...
    Images: ["https://picsum.photos/800/400?random=15","https://picsum.photos/800/400?random=16","https://picsum.photos/800/400?random=1","https://picsum.photos/800/400?random=2","https://picsum.photos/800/400?random=31","https://picsum.photos/800/400?random=32"],
    ApartmentType: 0,
  ...
  },
  {
    ...
    Images: ["https://picsum.photos/800/400?random=19","https://picsum.photos/800/400?random=20"],
    ApartmentType: 0,
    Location: "{\"address\": \"Ibn Gvirol 120, Tel Aviv\", \"latitude\": 32.085, \"longitude\": 34.781}",
    Price: 7600,
    Description: "Bright rental apartment, 5 min walk from Sarona Market.",
    AmountOfRooms: 3, AllowPet: false, AllowSmoking: false, ParkingSpace: 1,
    EntryDate: "2025-12-10T00:00:00", ExitDate: null,
    Rental_ContractLength: 12, Rental_ExtensionPossible: true,
    Shared_NumberOfRoommates: null, Roommates: "",
    Sublet_CanCancelWithoutPenalty: false, Sublet_IsWholeProperty: true,
    LabelsJson: '[{"value":"balcony"},{"value":"wifi"},{"value":"microwave"}]',
    NumOfLikes: 13, IsLikedByUser: false,
  },
  {
    ApartmentID: 111,
    Creator_ID: 11,
    ...
    Images: ["https://picsum.photos/800/400?random=21","https://picsum.photos/800/400?random=22"],
    ApartmentType: 1,
    Location: "{\"address\": \"HaArbaa 16, Tel Aviv\", \"latitude\": 32.071, \"longitude\": 34.789}",
    Price: 3900,
    Description: "Room in shared apartment in TLV, near Azrieli & Hashalom station.",
    AmountOfRooms: 4, AllowPet: true, AllowSmoking: false, ParkingSpace: 0,
    EntryDate: "2025-12-15T00:00:00", ExitDate: null,
    Rental_ContractLength: 12, Rental_ExtensionPossible: true,
    Shared_NumberOfRoommates: 2,
    Roommates: "Name:Yarden|Gender:Female|Job:Designer|BirthDate:1999-05-11|Image:https://i.pravatar.cc/100?img=17||Name:Alon|Gender:Male|Job:Developer|BirthDate:1996-07-03|Image:https://i.pravatar.cc/100?img=18",
    Sublet_CanCancelWithoutPenalty: false, Sublet_IsWholeProperty: false,
    LabelsJson: '[{"value":"wifi"},{"value":"tv"},{"value":"air conditioner"}]',
    NumOfLikes: 5, IsLikedByUser: false,
  },
  {
    ApartmentID: 112,
    ...
    Images: ["https://picsum.photos/800/400?random=23","https://picsum.photos/800/400?random=24"],
    ApartmentType: 0,
    Location: "{\"address\": \"Norther Bashan 8, Eilat\", \"latitude\": 29.555, \"longitude\": 34.956}",
    Price: 5400,
    Description: "Full sea view apartment, 2 min from promenade.",
    AmountOfRooms: 3, AllowPet: false, AllowSmoking: true, ParkingSpace: 1,
    EntryDate: "2025-10-01T00:00:00", ExitDate: null,
    Rental_ContractLength: 6, Rental_ExtensionPossible: true,
    Shared_NumberOfRoommates: null, Roommates: "",
    Sublet_CanCancelWithoutPenalty: false, Sublet_IsWholeProperty: false,
    LabelsJson: '[{"value":"balcony"},{"value":"parking"}]',
    NumOfLikes: 18, IsLikedByUser: false,
  },
  {
    ApartmentID: 113,
    Creator_ID: 13,
    ...
    Images: ["https://picsum.photos/800/400?random=25","https://picsum.photos/800/400?random=26"],
    ApartmentType: 1,
    Location: "{\"address\": \"HaShalom 6, Givatayim\", \"latitude\": 32.071, \"longitude\": 34.809}",
    Price: 4300,
    Description: "Room in shared central apartment, smart-home features.",
    AmountOfRooms: 4, AllowPet: true, AllowSmoking: false, ParkingSpace: 1,
    EntryDate: "2025-10-10T00:00:00", ExitDate: null,
    Rental_ContractLength: 12, Rental_ExtensionPossible: true,
    Shared_NumberOfRoommates: 2,
    Roommates: "Name:Lior|Gender:Female|Job:Marketing|BirthDate:1998-01-01|Image:https://i.pravatar.cc/100?img=19||Name:Or|Gender:Male|Job:Developer|BirthDate:1997-08-10|Image:https://i.pravatar.cc/100?img=12",
    Sublet_CanCancelWithoutPenalty: false, Sublet_IsWholeProperty: false,
    LabelsJson: '[{"value":"wifi"},{"value":"tv"},{"value":"parking"}]',
    NumOfLikes: 11, IsLikedByUser: true,
  },
  {
    ApartmentID: 114,
    Creator_ID: 14,
    ...
    Images: ["https://picsum.photos/800/400?random=27","https://picsum.photos/800/400?random=28"],
    ApartmentType: 2,
    Location: "{\"address\": \"Derech Hebron 120, Jerusalem\", \"latitude\": 31.753, \"longitude\": 35.222}",
    Price: 3000,
    Description: "Short sublet — close to old city.",
    AmountOfRooms: 2, AllowPet: true, AllowSmoking: false, ParkingSpace: 0,
    EntryDate: "2025-09-01T00:00:00", ExitDate: "2025-11-01T00:00:00",
    Rental_ContractLength: null, Rental_ExtensionPossible: false,
    Shared_NumberOfRoommates: null, Roommates: "",
    Sublet_CanCancelWithoutPenalty: true, Sublet_IsWholeProperty: true,
    LabelsJson: '[{"value":"wifi"},{"value":"microwave"}]',
    NumOfLikes: 4, IsLikedByUser: false,
  },
  {
    ApartmentID: 115,
    Creator_ID: 15,
    ...
    Images: ["https://picsum.photos/800/400?random=29","https://picsum.photos/800/400?random=30"],
    ApartmentType: 0,
    Location: "{\"address\": \"Hameyasdim 6, Rishon Lezion\", \"latitude\": 31.963, \"longitude\": 34.800}",
    Price: 6200,
    Description: "Family rental, quiet neighborhood, close to mall.",
    AmountOfRooms: 3, AllowPet: true, AllowSmoking: false, ParkingSpace: 1,
    EntryDate: "2025-12-12T00:00:00", ExitDate: null,
    Rental_ContractLength: 12, Rental_ExtensionPossible: true,
    Shared_NumberOfRoommates: null, Roommates: "",
    Sublet_CanCancelWithoutPenalty: false, Sublet_IsWholeProperty: false,
  ...
  },
  {
    ...
    Images: ["https://picsum.photos/800/400?random=31","https://picsum.photos/800/400?random=32"],
    ApartmentType: 1,
    Location: "{\"address\": \"Rothschild 80, Tel Aviv\", \"latitude\": 32.064, \"longitude\": 34.772}",
    Price: 4900,
    Description: "Shared apartment in Rothschild, gym in building.",
    AmountOfRooms: 4, AllowPet: false, AllowSmoking: false, ParkingSpace: 0,
    EntryDate: "2025-12-22T00:00:00", ExitDate: null,
    Rental_ContractLength: 12, Rental_ExtensionPossible: true,
    Shared_NumberOfRoommates: 2,
    Roommates: "Name:Chen|Gender:Female|Job:Designer|BirthDate:1998-10-03|Image:https://i.pravatar.cc/100?img=9||Name:Adam|Gender:Male|Job:Product Manager|BirthDate:1995-03-02|Image:https://i.pravatar.cc/100?img=16",
    Sublet_CanCancelWithoutPenalty: false, Sublet_IsWholeProperty: false,
    LabelsJson: '[{"value":"tv"},{"value":"wifi"},{"value":"ac"}]',
    NumOfLikes: 14, IsLikedByUser: true,
  },
  {
    ApartmentID: 117,
    Creator_ID: 17,
    ...
    Images: ["https://picsum.photos/800/400?random=33","https://picsum.photos/800/400?random=34"],
    ApartmentType: 2,
    Location: "{\"address\": \"HaShikma 3, Netanya\", \"latitude\": 32.332, \"longitude\": 34.857}",
    Price: 2800,
    Description: "Short sublet, beach view, perfect for vacations.",
    AmountOfRooms: 2, AllowPet: true, AllowSmoking: false, ParkingSpace: 0,
    EntryDate: "2025-08-01T00:00:00", ExitDate: "2025-10-01T00:00:00",
    Rental_ContractLength: null, Rental_ExtensionPossible: false,
    Shared_NumberOfRoommates: null, Roommates: "",
    Sublet_CanCancelWithoutPenalty: true, Sublet_IsWholeProperty: true,
  ...
  },
  {
    ...
    Images: ["https://picsum.photos/800/400?random=35","https://picsum.photos/800/400?random=36"],
    ApartmentType: 1,
    Location: "{\"address\": \"Haatzmaut 9, Beer Sheva\", \"latitude\": 31.252, \"longitude\": 34.792}",
    Price: 3500,
    Description: "Shared student apartment next to Ben Gurion University.",
    AmountOfRooms: 3, AllowPet: false, AllowSmoking: true, ParkingSpace: 0,
    EntryDate: "2025-09-15T00:00:00", ExitDate: null,
    Rental_ContractLength: 12, Rental_ExtensionPossible: false,
    Shared_NumberOfRoommates: 2,
    Roommates: "Name:Shir|Gender:Female|Job:Student|BirthDate:2001-05-01|Image:https://i.pravatar.cc/100?img=59||Name:Omer|Gender:Male|Job:Student|BirthDate:2000-10-10|Image:https://i.pravatar.cc/100?img=61",
    Sublet_CanCancelWithoutPenalty: false, Sublet_IsWholeProperty: false,
  ...
  },
  {
    ...
    Images: ["https://picsum.photos/800/400?random=37","https://picsum.photos/800/400?random=38"],
    ApartmentType: 0,
    Location: "{\"address\": \"Emek Refaim 90, Jerusalem\", \"latitude\": 31.759, \"longitude\": 35.219}",
    Price: 5600,
    Description: "Quiet rental apartment, lots of natural light.",
    AmountOfRooms: 3, AllowPet: false, AllowSmoking: false, ParkingSpace: 1,
    EntryDate: "2025-10-05T00:00:00", ExitDate: null,
    Rental_ContractLength: 12, Rental_ExtensionPossible: true,
    Shared_NumberOfRoommates: null, Roommates: "",
    Sublet_CanCancelWithoutPenalty: false, Sublet_IsWholeProperty: false,
  ...
  },
  {
    ...
    Images: ["https://picsum.photos/800/400?random=39","https://picsum.photos/800/400?random=40"],
    ApartmentType: 2,
    Location: "{\"address\": \"HaPalmach 30, Haifa\", \"latitude\": 32.793, \"longitude\": 34.986}",
    Price: 3200,
    Description: "Short sublet in Carmel Center, ocean view.",
    AmountOfRooms: 2, AllowPet: true, AllowSmoking: false, ParkingSpace: 0,
    EntryDate: "2025-07-01T00:00:00", ExitDate: "2025-09-01T00:00:00",
    Rental_ContractLength: null, Rental_ExtensionPossible: false,
    Shared_NumberOfRoommates: null, Roommates: "",
    Sublet_CanCancelWithoutPenalty: true, Sublet_IsWholeProperty: true,
    LabelsJson: '[{"value":"wifi"},{"value":"tv"}]',
    NumOfLikes: 9, IsLikedByUser: true,
  },
];
